...
const TopHolidayPackages = () => {
  ...
  return (
    <section className="container p-3 mx-auto">
      <div>
        <h2 className="text-3xl font-bold text-center mt-5 mb-8">Explore Our Top Holiday Packages</h2>
      ...
      <div className="text-center mt-6 justify-center items-center flex">
        <button
          className="bg-green-500 rounded-full  hover:bg-red-500  text-white py-2 px-6"
        >
      <NavLink to='/allpackage'>See All Packages</NavLink>
        </button>
      </div>
      </div>
    </section>
